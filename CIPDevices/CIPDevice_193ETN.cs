...
namespace powerFlexBackup.cipdevice
{
    ...
    public class CIPDevice_193ETN : CIPDevice{
        public CIPDevice_193ETN(String deviceAddress, Sres.Net.EEIP.EEIPClient eeipClient, byte[] CIPRoute, IOptions<AppConfiguration> options, ILogger logger, IdentityObject identityObject) :
        ...
        public string parameterListJSON = @"[
            ...
            { 'number': 11, 'name': 'Reserved', 'defaultValue': '0', 'record': false, 'type': 'xw==' },
            ...
            { 'number': 14, 'name': 'Trip Reset', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },
            { 'number': 15, 'name': 'Single/Three Ph', 'defaultValue': 'True', 'record': true, 'type': 'wQ==' },
            { 'number': 16, 'name': 'OL Reset Mode', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },
            ...
            { 'number': 26, 'name': 'Reserved', 'defaultValue': '0', 'record': false, 'type': 'xw==' },
            { 'number': 27, 'name': 'Reserved', 'defaultValue': '0', 'record': false, 'type': 'xw==' },
            { 'number': 28, 'name': 'Reserved', 'defaultValue': '0', 'record': false, 'type': 'xw==' },
            { 'number': 29, 'name': 'Reserved', 'defaultValue': '0', 'record': false, 'type': 'xw==' },
            ...
            { 'number': 36, 'name': 'OutA En FltState', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },
            { 'number': 37, 'name': 'OutA En FltValue', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },
            { 'number': 38, 'name': 'OutA En IdlState', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },
            { 'number': 39, 'name': 'OutA En IdlValue', 'defaultValue': 'False', 'record': true, 'type': 'wQ==' },

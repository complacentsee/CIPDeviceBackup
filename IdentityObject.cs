...
namespace powerFlexBackup.cipdevice
{
    public class IdentityObject
    {
        ...
        public static IdentityObject getIdentityObjectfromResponse(byte[] IdentityObjectBytes, ILogger logger)
        {
            ...
            logger.LogDebug ("SerialNumber: {0:X}", IdentityObject.SerialNumber);
            ...
            logger.LogDebug ("ProductName: " + IdentityObject.ProductName);
